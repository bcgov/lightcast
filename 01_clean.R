...
#top job titles within each NOC
tbbl|>
  group_by(noc_2021_5_name, title_clean)|>
  count()|>
  group_by(noc_2021_5_name)|>
  slice_max(order_by = n, n = 10)|>
  collect()|>
  na.omit()|>
  write_rds(here("data","top_titles.rds"))
